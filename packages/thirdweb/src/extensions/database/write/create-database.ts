 ...
 * @param {CreateDatabaseOptions} param
 * @param {@link Account} param.account - The deployer account
 * @param {@link Chain} param.chain - The chain to deploy the database on
 * @param {@link ThirdwebClient} param.client - The thirdweb client to use
 * @param {string} param.name - The name of the new database
 *
