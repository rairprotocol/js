 ...
 * @param {GetDatabaseParams} param
 * @param {string} param.ownerAddress - The address to receive owned databases for
 * @param {@link Chain} param.chain - The chain to retrieve databases for
